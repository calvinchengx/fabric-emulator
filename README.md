...
| | Claims | Meaning |
|---|---|---|
| 🟢 **Real** | **135** | Witnessed — `check_witnesses.py --strict` fails CI if a supported claim loses its witness. Genuine work: real signed JWTs, real bytes, a real engine or client computes |
