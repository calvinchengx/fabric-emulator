...
| 2 | Signature shape | ❌ 7 documented method(s) absent: create, delete, get, getDefinition, lis ([§2](38-framework-conformance.md#2-the-api-shape-is-the-contract-independent-of-behaviour)) | ❌ no signatures in the findings artifact — the session did not get as fa ([§2](38-framework-conformance.md#2-the-api-shape-is-the-contract-independent-of-behaviour)) | — |
