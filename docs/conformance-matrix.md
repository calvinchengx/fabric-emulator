...
| 6 | Rewrite fall-through | ✅ | ❌ not run on this backend: the statements address the table by `abfss:// ([§6](38-framework-conformance.md#6-engine-gaps-need-a-bounded-rewrite-escape-hatch-with-a-stated-contract)) | ❌ not yet asserted — same harness as write landing, different notebooks ([§6](38-framework-conformance.md#6-engine-gaps-need-a-bounded-rewrite-escape-hatch-with-a-stated-contract)) |
