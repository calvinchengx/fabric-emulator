...
| Deployment pipelines — role-assignment CRUD (D3) | Endpoints absent; the creator is Admin and access is enforced, but grants can't be managed over REST | 🔴 Not implemented |
