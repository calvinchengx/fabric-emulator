...
# build in examples/medallion-dbt-fabricspark can be compared against it without either
# example having to import the other's code. See that example's compare.py.
summary = {
    "engine": "dbt-fabric",
