...
// references, `SUM`, `DIVIDE`, `COUNTROWS`, `IF`, `ACOS`, `ABS`, `ROUND`, `LOG`, `LOG10`, `INT`, `SQRT`, `MOD`, `SIGN`, `ASIN`, `ATAN`, `PI`, `SIN`, `COS`, `TAN`, `DEGREES`, `RADIANS`, `DATE`, `YEAR`, `MONTH`, `DAY`, `TIME`, `HOUR`, `MINUTE`, `SECOND`, the infix operators
...
func (e *evalr) evalFunc(fc funcCall) (any, error) {
	...
	case "MOD":
		...
		// BLANK divisor is 0 via arithNum — Desktop: division by zero.
		...
		// Excel/DAX: n - d * INT(n/d), INT = floor toward −∞.
		// Go math.Mod is remainder toward zero (Mod(-10, 3) = -1);
		// Desktop MOD(-10, 3) = 2.
